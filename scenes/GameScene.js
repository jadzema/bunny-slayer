class GameScene extends Phaser.Scene {
  ...
  create() {
    ...
    this.physics.world.setBounds(26, 26, 748, 548);
  ...
  _drawFences() {
    for (let x = 0; x < 800; x += 32) {
      ...
      this.add.image(x + 16, 587, 'fence_h').setDepth(1);
    }
    for (let y = 24; y < 576; y += 32) {
      this.add.image(13,  y + 16, 'fence_v').setDepth(1);
      this.add.image(787, y + 16, 'fence_v').setDepth(1);
    }
  }
  ...
  _spawnObstacles() {
    ...
    for (let i = 0; i < count; i++) {
      ...
      do {
        ...
        tries++;
      } while (Phaser.Math.Distance.Between(x, y, 400, 300) < 110 && tries < 30);
  ...
  _spawnBunnies() {
    ...
    for (let i = 0; i < count; i++) {
      ...
      do {
        ...
        Phaser.Math.Distance.Between(x, y, 400, 300) < 90 ||
